...
const BloodPressurePatientDetails = ({route, navigation}) => {
  ...
  useEffect(() => {
    ...
    if (userEmail != null) {
      Axios.post(backendUrl + 'bloodPressurePatientMealList', {
        userEmail,
  ...
  const handleDelete = id => {
    Axios.post(backendUrl + 'deletebloodPressurePatientMeal', {
      userEmail,
      id,
      bloodPressurePatientId: bloodPressurePatient.id,
    })
        ...
        <View
          ...
          <View>
            <View
              ...
              <TouchableOpacity
                onPress={() => {
                  navigation.navigate('BloodPressurePatientMeal', {
...
export default BloodPressurePatientDetails;
